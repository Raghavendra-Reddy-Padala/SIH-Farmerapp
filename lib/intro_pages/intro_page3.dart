      ...
      body: SingleChildScrollView( 
        ...
        child: Column(
          ...
          children: [
            ...
            AspectRatio(
              aspectRatio: 3 / 2, 
              child: Image.network("https://th.bing.com/th/id/OIP.r250L4chdUyVzMOaQCr_OQHaHa?w=171&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7",
                fit: BoxFit.cover,
              ),
            ),
            SizedBox(height: screenHeight * 0.1), 
              ...
              child: RichText(
                ...
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text: 'Hello friends dengi tinar modda gudud tinava\nne peru enid ra', // Adjusted content
                      style: GoogleFonts.gabarito(
